    ...
    return (
        <div className='bg-base-100 rounded-3xl p-20 mb-10 flex flex-col gap-10'>
            ...
            <div className="flex items-center w-full max-w-xl mx-auto bg-white rounded-full shadow-md h-12 pl-3">
                ...
                {/* Search Button */}
                <button className="bg-secondary hover:bg-secondary/90 text-md font-semibold px-10 h-full rounded-full transition">
                    Search
                </button>
            </div>

            <CoverageMap serviceLocations={serviceLocations} />
        </div>
    );
};
